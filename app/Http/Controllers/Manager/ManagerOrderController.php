...
class ManagerOrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $OrderList = Order::where('sale_manager_id', $salesExicutiveId)
                    ->with('customer') // Eager load customer details
                    ->get();

        // Pass the company and comId to the view
        return view('manager.order.index', compact('OrderList'));
    }
    public function add()
    {
        ...
        // Pass the company and comId to the view
        return view('manager.order.add', compact('users','productfounder'));
    }
    public function store(Request $request)
    {
        $user = Auth::user();
        $salesExicutiveId = $user->id;
        $salemanagerId = $user->sale_manager;
        ...
        try {
            ...
            return redirect()->route('manager.order.index')->with('success', 'Order placed successfully.');
        } catch (\Exception $e) {
            dd($e);
    ...
    public function view($id)
    {
        try {
            ...
            // Pass the company and comId to the view
            return view('manager.order.view', compact('users','productfounder','order'));
