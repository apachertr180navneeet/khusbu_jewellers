...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->enum('role',['super admin','executive','manager','product founder', 'payment check','logistic','billing','packing','calling','purchase','manufacturing'])->default('sales executive');
